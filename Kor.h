...
public:
	Kor(double x,double y ,  double sugar, AlakzatNev nev):Alakzat(x_kiszamito(x,y,sugar),y_kiszamito(x,y,sugar),konstans_kiszamito(x,y,sugar), nev),xNegyzet(1.0),yNegyzet(1.0){}
